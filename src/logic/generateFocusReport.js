...
<title>FOCUS10010 Lifetime Analytics Report</title>
...
<h1 class="font-display-lg-mobile md:font-display-lg text-display-lg-mobile md:text-display-lg text-primary mb-2">FOCUS10010 Lifetime Report</h1>
...
<div class="font-label-caps text-label-caps text-on-surface-variant opacity-50 text-center md:text-right">Generated by Focus10010 • <span id="timestamp">Jul 6, 2026, 07:36 PM GMT+5:30</span></div>
</div>
</footer>
<script>
...
<meta charset="utf-8">
<meta content="width=device-width, initial-scale=1.0" name="viewport">
<title>Focus10010 Monthly Report</title>
<script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script>
...
<div>
<h1 class="font-report-title text-report-title text-primary tracking-tighter">FOCUS10010</h1>
...
<div class="font-label-caps text-label-caps text-on-surface-variant uppercase">Generated by Focus10010 • ${formatMedium(new Date())}</div>
...
<head>
    <meta charset="utf-8"/>
    <meta content="width=device-width, initial-scale=1.0" name="viewport"/>
    <title>FOCUS10010 ${periodLabel} Report</title>
    <script src="https://cdn.tailwindcss.com?plugins=forms,container-queries"></script>
...
<div class="bg-theme-bg shadow-2xl relative overflow-hidden a4-container">
    ...
    <header class="bg-theme-bg border-b border-outline-variant flex justify-between items-center w-full px-page-margin py-6 mx-auto">
        <div class="flex flex-col">
            <h1 class="font-report-title text-report-title text-primary tracking-tighter">FOCUS10010 ${periodLabel} Report</h1>
    ...
    <footer class="bg-theme-bg border-t border-outline-variant flex justify-between items-center w-full px-page-margin py-8 mt-auto">
        <div class="flex flex-col gap-2">
            <span class="font-label-caps text-label-caps text-on-surface-variant tracking-widest">Focus10010 Analytics Methodology • Confidential Executive Report</span>
        ...
        <div class="flex gap-6">
            <span class="font-body-md text-body-md text-on-surface-variant opacity-70">Focus10010.app</span>
        </div>
    </footer>
</div>
</body>
  ...
  link.href = url;
  link.download = `Focus10010_${period}_report_${fmtDate(new Date())}.html`;
